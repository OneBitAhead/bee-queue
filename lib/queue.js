...
/**
 * in order to be able to bundle bee-queue via esbuild 
 * use requires and later build it with loader: { '.lua': 'text' } or -loader:.lua=text
 * BUILD SCRIPT
 * define: {
 *   'process.env.LUA_BUNDLE_MODE': '"1"', // or whatever value you want
 *  }
 *}
 * via cli: --define:process.env.LUA_BUNDLE_MODE='"1"'
 * 
 */
